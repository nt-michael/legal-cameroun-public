...
export async function generateMetadata(): Promise<Metadata> {
  return createPageMetadata('/actualite', {
    ...
    twitter: {
      ...
      title: 'Actualité Juridique & Fiscale au Cameroun',
      description: 'Analyses, guides pratiques et actualités du droit des affaires au Cameroun. Restez informé des évolutions juridiques et fictales avec nos experts.',
    },
    alternates: {
      languages: {
